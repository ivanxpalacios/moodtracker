import { getEntryEdit, editEntry } from './API.js';
...
(function() {
    ...
    async function createsURL() {
        ...
        const entryToFillForm = await getEntryEdit(idEntry);

        fillInputs(entryToFillForm);

        const { date, mood, thoughts, gratitude, id } = entryToFillForm;
    ...
    function fillInputs(entry) {
        ...
        selectMood.value = mood;
        inputThoughts.value = thoughts;
        inputGratitude.value = gratitude;
        inputId.value = id;
    }
    ...
    function submitForm(e) {
        ...
        setTimeout(() => {
            ...
            alertSuccess.textContent = 'Your entry was edited succesfully';
